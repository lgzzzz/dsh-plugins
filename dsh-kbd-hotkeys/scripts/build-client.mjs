 ...
 *
 * 步骤:1) esbuild 把 src/client.ts 连同相对导入(src/config.ts、src/actions.ts、
 * src/overlay.ts)打包为单文件(bundle,全部内联,本插件不消费 external);
 * 2) 包进 window.__ModuleLoader__.load({ id, factory }) 写回 lib/client.js。
 *
...
const loaderId = 'dsh-kbd-hotkeys'
