 ...
 *
 * 步骤:1) esbuild 把 src/client.ts 打包为单文件(bundle,全部内联,本插件
 * 不消费 external);2) 包进 window.__ModuleLoader__.load({ id, factory })
 * 写回 lib/client.js。
 *
 * 注意事项:浏览器不跑 Node Type Stripping,且 ModuleLoader 只按模块 id 解析
 * require、不支持相对路径。lib/client.js 为生成产物、禁止手改,入仓以便离线
 * 加载。
 */
...
const loaderId = 'dsh-no-right-sidebar'
