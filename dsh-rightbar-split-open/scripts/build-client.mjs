 ...
 *
 * 步骤:
 *   1) 用 esbuild 把 src/client.ts 连同相对导入(src/split-open.ts、src/rightbar.ts、
 *      src/types.ts)打包为单文件 CJS(bundle,全部内联,本插件不消费 external),
 *      先落到 lib/.client.cjs;
 ...
 * 与 dsh-kbd-hotkeys / dsh-rightbar-tab-width 的构建脚本同一做法。
 *
...
const loaderId = 'dsh-rightbar-split-open'
