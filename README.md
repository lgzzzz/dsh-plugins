...
# 全部本地插件（写成一行即可）
dsh plugin --profile web remove dsh-code-card-fonts dsh-directory-picker-browse dsh-fullwidth-chat dsh-git-guard dsh-kbd-hotkeys dsh-rightbar-fonts dsh-rightbar-tab-width dsh-sidebar-default-collapsed
# 重启 App 生效
```
