...
const CSS = [
  ...
  '.dscList{list-style:none;flex-direction:row;flex-wrap:wrap;gap:6px 8px;margin:0;padding:0;display:flex;min-width:0;width:100%}',
  '.dscList li{max-width:100%;min-width:0}',
  '.dscFile{background:var(--dsw-alias-interactive-bg-hover);width:fit-content;max-width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:none;border-radius:6px;margin:0;padding:2px 8px;display:flex;align-items:center;gap:8px;min-width:0;text-align:left}',
